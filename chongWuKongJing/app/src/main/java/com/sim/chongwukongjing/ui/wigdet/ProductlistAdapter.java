 ...
 * @author binshengzhu
 */
public class ProductlistAdapter extends BaseQuickAdapter<ProductlistResult.DataBean, BaseViewHolder> {

    private Activity mcontext;

    public ProductlistAdapter(@LayoutRes int layoutResId, @Nullable List<ProductlistResult.DataBean> data, Activity context) {
