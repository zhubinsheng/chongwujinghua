...
import com.sim.chongwukongjing.ui.wigdet.ProductlistAdapter;
                ...
                .subscribe(new Consumer<ProductlistResult>() {
                    ...
                    public void accept(ProductlistResult baseInfo) throws Exception {
                        if ("10000".equals(baseInfo.getCode())){
                            ...
                            productlistAdapter = new ProductlistAdapter(R.layout.productlist_itemview, data,FindEquipmentActivity.this);
                            //条目点击事件
